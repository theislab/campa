...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Setup CAMPA: create campa.ini")
    parser.add_argument('--force', action='store_true', help='force recreation of campa.ini even if exists')
